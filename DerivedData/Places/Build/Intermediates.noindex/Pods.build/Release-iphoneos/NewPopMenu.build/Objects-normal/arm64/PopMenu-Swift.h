...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PopMenu",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Customize your own action and conform to <code>PopMenuAction</code> protocol.
SWIFT_PROTOCOL("_TtP7PopMenu13PopMenuAction_")
...
@property (nonatomic, readonly, copy) void (^ _Nullable didSelect)(id <PopMenuAction> _Nonnull);
/// Left padding when texts-only.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) CGFloat textLeftPadding;)
+ (CGFloat)textLeftPadding SWIFT_WARN_UNUSED_RESULT;
/// Icon left padding when icons are present.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) CGFloat iconLeftPadding;)
+ (CGFloat)iconLeftPadding SWIFT_WARN_UNUSED_RESULT;
/// Icon sizing.
...
- (void)actionSelectedWithAnimated:(BOOL)animated;
@end


/// Appearance for PopMenu.
/// Use for configuring custom styles and looks.
SWIFT_CLASS("_TtC7PopMenu17PopMenuAppearance")
...
SWIFT_CLASS("_TtC7PopMenu20PopMenuDefaultAction")
...
SWIFT_CLASS("_TtC7PopMenu33PopMenuDismissAnimationController")
...
SWIFT_CLASS("_TtC7PopMenu19PopMenuGradientView")
@interface PopMenuGradientView : UIView
...
SWIFT_CLASS("_TtC7PopMenu33PopMenuPresentAnimationController")
@interface PopMenuPresentAnimationController : NSObject <UIViewControllerAnimatedTransitioning>
/// Duration of the transition.
- (NSTimeInterval)transitionDuration:(id <UIViewControllerContextTransitioning> _Nullable)transitionContext SWIFT_WARN_UNUSED_RESULT;
/// Animate PopMenuViewController custom transition.
- (void)animateTransition:(id <UIViewControllerContextTransitioning> _Nonnull)transitionContext;
...
SWIFT_CLASS("_TtC7PopMenu21PopMenuViewController")
...
///
/// \param coordinator Coordinator that manages the container
///
...
@interface PopMenuViewController (SWIFT_EXTENSION(PopMenu)) <UIViewControllerTransitioningDelegate>
...
SWIFT_PROTOCOL("_TtP7PopMenu29PopMenuViewControllerDelegate_")
@protocol PopMenuViewControllerDelegate
@optional
